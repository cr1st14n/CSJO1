...
@endif
		...
		<nav id="menu"  data-search="close">
			<ul>
				...
				<li><a href="{{route('rrhh_home')}}"><i class="icon  fa fa-home"></i> RRHH  </a></li>
				<li class="Label label-lg  text-center" >Gestionar Usuarios</li>
				<li><span><i class="icon  fa  fa-users"></i>Registro y acceso de usuarios  </span>
					<ul>
						<li class="Label label-lg  text-center" >Accesso al sistema</li>
						<li><a href="{{route('formNewuserA') }} "><i class="icon  fa fa-pencil"></i> Agregar personal  </a></li>
						<li><a href="{{route('storeUsers')}} "><i class="icon  fa fa-search"></i> Listar personal</a></li>
						<li class="Label label-lg  text-center" >Gestionar Personal de salud</li>
						<li><a href="{{route('formPS') }} "><i class="icon  fa fa-user"></i>Personal Medico </a></li>
					</ul>
				</li>
				...
				<li class="Label label-lg  text-center" >Estado y Reportes</li>
				<li><a href="{{route('admReportHome')}} "> <i class="icon  fa fa-book"></i>Generar reporte</a></li>
			</ul>
		</nav>
		<!-- //nav left menu-->
