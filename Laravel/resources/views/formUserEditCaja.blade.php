...
<div class="col-lg-6">
<form  class="" method="POST" action="{{ route('store_user_caja_update_date') }}">
  {{ csrf_field() }}
...
<!-- seguada columna -->
<div class="col-lg-6">
<form  class="" method="POST" action="{{ route('store_user_caja_update_email') }}">
  {{ csrf_field() }}
    ...
    <div class="panel-body">
        <div  class="form-horizontal" data-collabel="3" data-alignlabel="center">
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="password" type="password" class="form-control rounded" name="password" data-always-show="true" maxlength="6" onkeypress="return soloNu(event)" onblur="limpia()">
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="password-confirm" type="password" class="form-control rounded" name="password_confirmation" data-always-show="true" maxlength="6" onkeypress="return soloNu(event)" onblur="limpia()">
