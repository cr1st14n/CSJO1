<form  class="" method="POST" action="{{ route('registerPS') }}">
  {{ csrf_field() }}
<section class="panel corner-flip">
    <header class="panel-heading sm" data-color="theme-inverse">
            <h2><strong>Registro </strong> Nuevo personal Medico</h2>
    </header>
    ...
    <div class="panel-body">                       
        <div   class="form-horizontal" data-collabel="4" data-alignlabel="center">          
            <div class="form-group{{ $errors->has('ps_ci') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="ps_ci" type="text" class="form-control rounded" name="ps_ci" value="{{ old('ps_ci') }}"  maxlength="10" data-always-show="true" onkeypress="return soloNu(event)" onblur="limpia()">
                    @if ($errors->has('ps_ci'))
            ...
            <div class="form-group{{ $errors->has('ps_nombre') ? ' has-error' : '' }}">
                    ...
                    <div >
                            <input id="ps_nombre" name="ps_nombre" value="{{ old('ps_nombre') }}" type="text" class="form-control rounded" maxlength="30" data-always-show="false" onkeypress="return soloLe(event)" onblur="limpia()" > 
            ...
            <div class="form-group{{ $errors->has('ps_appaterno') ? ' has-error' : '' }}">
                    ...
                    <div>
                            <input id="ps_appaterno" name="ps_appaterno" type="text" value="{{ old('ps_appaterno') }}" class="form-control rounded" maxlength="30" data-always-show="false" onkeypress="return soloLe(event)" onblur="limpia()">
            ...
            <div class="form-group{{ $errors->has('ps_apmaterno') ? ' has-error' : '' }}">
                    ...
                    <div>
                            <input id="ps_apmaterno" name="ps_apmaterno" value="{{ old('ps_apmaterno') }}" type="text" class="form-control rounded"  maxlength="30" data-always-show="false" onkeypress="return soloLe(event)" onblur="limpia()">
            ...
            <div class="form-group{{ $errors->has('ps_telf') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                            <input id="ps_telf" name="ps_telf" type="text" value="{{ old('ps_telf') }}" class="form-control rounded" maxlength="10" data-always-show="true" onkeypress="return soloNu(event)" onblur="limpia()">
            ...
            <div class="form-group{{ $errors->has('ps_especialidad') ? ' has-error' : '' }}">
                ...
                <div>
                    <input id="ps_especialidad" name="ps_especialidad" type="text" value="{{ old('ps_especialidad') }}" class="form-control rounded"  maxlength="20" data-always-show="false" onkeypress="return soloLe(event)" onblur="limpia()">
