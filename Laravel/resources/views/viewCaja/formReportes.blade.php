...
<div class="col-lg-6">
    <section class="panel">
            ...
            <form class="form-horizontal" data-collabel="5" method="any" action="{{route('reporteDiario')}} ">
...
<div class="col-lg-6">
    <section class="panel">
            ...
            <form class="form-horizontal" data-collabel="5" method="any" action="{{route('reporteMensual')}} ">
                <div class="panel-body">
                        <div class="form-group">
                                <label class="control-label">Area del reporte</label>
                                <div>
